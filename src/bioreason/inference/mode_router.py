...
ROUTER_INSTRUCTION = (
    ...
    "- PIPELINE_DEBUG: user reports an error, exception, or something broken, "
    "in the context of a pipeline\n"
    "- CODE_EXPLANATION: user asks what a piece of code does or how it maps to "
    "a computational/biological concept, without an active pipeline error\n"
